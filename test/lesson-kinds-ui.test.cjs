...
test('the admin plan card lists lines with status, opens one editor at a time, and sends line operations with the line id and revision', async () => {
  ...
  assert.match(ui.html(), /<div class="plan-grid"><div class="plan-gh">科目<\/div><div class="plan-gh">種類<\/div><div class="plan-gh">回数<\/div><div class="plan-gh">期間<\/div><div class="plan-gh">時間<span[^>]*>1回の料金<\/span><\/div><div class="plan-gr" data-line="p1"><div class="plan-gc">英語<\/div><div class="plan-gc">通常<\/div><div class="plan-gc">4回<\/div><div class="plan-gc">9月<\/div><div class="plan-gc">90分<span class="sub">3,000円<\/span><\/div><\/div><div class="plan-gs" data-line="p1">[^]*?<button class="btn-quiet btn-sm" data-action="pe-open" data-line="p1"[^>]*>✎<\/button><button class="btn-quiet btn-sm" data-action="plancopy" data-line="p1">/);
  assert.match(ui.html(), /<div class="plan-gr" data-line="a1"><div class="plan-gc">数学<\/div><div class="plan-gc">演習<\/div><div class="plan-gc">4回<br><span class="small muted">承認 3回<\/span><\/div><div class="plan-gc">9\/22〜<wbr>10\/5<\/div><div class="plan-gc">60分<span class="sub">3,000円<\/span><\/div><\/div>/); assert.match(ui.html(), /承諾: 2026-09-05・LINE/);
