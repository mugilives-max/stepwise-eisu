...
test('the admin day card mirrors the student 予定の編集 card with teacher actions', async () => {
  ...
  assert.match(ui.html(), /<span class="tag gray">実施済<\/span><a class="lesson-link" href="#lesson\?student=test-a&amp;slot=l3"[^>]*><span class="time">15:00〜16:00<\/span><span class="who">国語<\/span><\/a><button class="btn-quiet btn-sm" style="margin-left:auto" data-action="toggledone" data-id="l3" data-done="0">未実施に戻す<\/button>/);
  assert.match(ui.html(), /<span class="tag green">確定<\/span><a class="lesson-link" href="#lesson\?student=test-a&amp;slot=l1"[^>]*><span class="time">17:00〜18:30<\/span><span class="who">英語（演習）<\/span><\/a><a class="btn-ghost btn-sm"[^>]*>Meet<\/a><button class="btn-quiet btn-sm" data-action="toggledone" data-id="l1" data-done="1">実施済にする<\/button><button class="btn-quiet btn-sm" data-action="unbook" data-id="l1"/);
