...
test('default count saves send subject, kind and count without a month or revision', async () => {
  ...
  assert.match(ui.html(), /<div class="plan-gr" data-line="line-1"><div class="plan-gc">英語<span class="sub">通常<\/span><\/div><div class="plan-gc">4回<\/div><div class="plan-gc">9月<\/div><div class="plan-gc">90分<span class="sub">4,500円<\/span><\/div><\/div>/);
  setPlan(ui, 6);
